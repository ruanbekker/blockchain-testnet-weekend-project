...
# This script gets triggered by the walletnotifier and checks once the transaction is cofirmed, it writes it into mongodb
...
# env vars
wallet_node_username = "user"
wallet_node_password = "pass"
wallet_node_base_url = "http://127.0.0.1:16001"
wallet_name = "main"
...
# "16f5a556f8ffc18f8d49bf1d08979896a4b02012b67df41cac43d3b98c424691"

def get_transaction(wallet_name, txid):
    request_url = "{url}/wallet/{wallet_name}".format(url=wallet_node_base_url, wallet_name=wallet_name)
...
def get_balance(wallet):
    request_url = "http://127.0.0.1:{port}/wallet/{wallet}".format(port=rpc_port,wallet=wallet)
