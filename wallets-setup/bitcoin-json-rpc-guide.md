# Bitcoin JSON RPC Guide

This guide will show the basics on how to get your account setup and create a bitcoin address so that we can send funds to your account.

## Pre-Requisites

Before you can continue you must have bitcoin running and fully synced, the guide to do that can be found below:

- [Bitcoin Full Node Setup on ARM](https://github.com/ruanbekker/blockchain-testnet-weekend-project/blob/main/nodes-setup/bitcoin-testnet-arm.md)
...
```bash
$ sudo systemctl is-active bitcoind
active
```
...
```bash
$ sudo netstat -tulpn | grep bitcoind
tcp        0      0 0.0.0.0:18332           0.0.0.0:*               LISTEN      542/bitcoind
tcp        0      0 0.0.0.0:18333           0.0.0.0:*               LISTEN      542/bitcoind
tcp        0      0 127.0.0.1:18334         0.0.0.0:*               LISTEN      542/bitcoind
```
